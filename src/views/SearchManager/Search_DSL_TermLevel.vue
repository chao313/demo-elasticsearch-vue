                            ...
                            <el-form :inline="true" size="mini" :label-position="left">
                                <el-collapse>
                                    <el-collapse-item :title="'字段值筛选'+boolType" name="1">
                                        ...
                                        <el-form-item>
                                            <el-button type="primary" class="el-button-search"
                                                       @click="DSLAdd(boolType,'wildcard')">
                                                +
                                            </el-button>
                                        </el-form-item>
